...
const reviewsData: ReviewsDataType[] = [
    {
        ...
        image: "src/assets/images/customer-01.svg"
    },
    {
        id: 2,
        ...
        image: "src/assets/images/customer-02.svg"
    },
    {
        id: 3,
        ...
        image: "src/assets/images/customer-03.svg"
    }
];
...
const ReviewCard = ({
    ...
    for (let i = 0; i < stars; i++) {
        starSVGs.push(
            <svg key={i} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-8 fill-amber-300">
    ...
    return (
        <div className="rounded-2xl bg-gradient-to-br from-orange-500 via-gray-700 to-gray-700 p-0.25 m-1">
            <div className="relative rounded-2xl grid content-center place-items-center bg-gray-50 dark:bg-gray-950 p-10 min-h-[350px]">
                ...
                <p className="md:text-xl text-sm text-center px-5">
                    “{quote}”
                </p>
                <p className="md:text-xl text-sm mt-5">{name}</p>
                <p className="md:text-xl text-sm globaltextcolortheme mb-5">{title}</p>
